...
export default function IntakePage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-primary/20 overflow-x-hidden relative transition-colors duration-300">
      ...
      <nav className="relative z-50 border-b border-border bg-background/60 backdrop-blur-md">
      ...
      <main className="relative z-10 px-6 py-20">
        ...
        {!manualMode ? (
          <div className="space-y-8">
            <div
              ...
              className={`group relative overflow-hidden rounded-[2.5rem] p-16 text-center cursor-pointer transition-all duration-500 border-2 border-dashed ${
                dragging
                  ? "border-primary bg-primary/[0.04] shadow-2xl shadow-primary/10"
            ...
            >
              {loading ? (
                ...
                <div className="flex flex-col items-center gap-6">
                  <div className="size-20 rounded-3xl bg-primary flex items-center justify-center shadow-lg shadow-primary/20 group-hover:scale-110 transition-transform">
                    {dragging ? (
                  ...
                  <div className="space-y-2">
                    <p className="text-xl font-bold text-foreground">Drop your job posting here</p>
            ...
            {error && (
              <div className="flex items-center gap-3 p-4 rounded-2xl bg-destructive/[0.06] border border-destructive/20 text-destructive text-sm font-medium animate-in slide-in-from-top-2">
          ...
          <form onSubmit={handleManualSubmit} className="space-y-8 bg-card backdrop-blur-md border border-border p-10 rounded-[2.5rem] shadow-xl animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="space-y-6">
              <div className="space-y-2">
                <label className="text-xs font-bold uppercase tracking-widest text-muted-foreground ml-1">Job Title</label>
                <input
                  value={manualRole}
