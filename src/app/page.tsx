  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100">
      ...
      <section className="px-6 py-24 text-center max-w-3xl mx-auto">
        ...
        <Link
          href="/intake"
          className="inline-flex items-center gap-2 bg-teal-500 hover:bg-teal-400 text-gray-950 font-semibold px-8 py-4 rounded-lg text-lg transition-colors"
        >
      ...
      <section className="px-6 py-16 max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {[
            ...
            <div key={step} className="relative p-6 rounded-xl border border-white/10 bg-white/[0.02]">
              ...
              {step !== "4" && (
                <ChevronRight className="hidden md:block absolute -right-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-600" />
              )}
            </div>
          ))}
        </div>
